...
if (window.location.href.toLowerCase().indexOf("astrology.com") >= 0) {
	document.write('<scr'+'ipt  language="javascript" type="text/javascript" src="//a248.e.akamai.net/7/123/80964/0s/contest-www.astrology.com/javascripts/ivillage/iv_nv_s_code.js"></scr'+'ipt>');
}
...
document.write('<scr'+'ipt language="javascript" type="text/javascript" src="https://edge.quantserve.com/quant.js"></scr'+'ipt>');
document.write('<noscript>'+'<a href="https://www.quantcast.com/p-9eJ8k4iSzux46" target="_blank"><img src="https://pixel.quantserve.com/pixel/p-9eJ8k4iSzux46.gif?labels=iVillage" style="display: none;" border="0" height="1" width="1" alt="Quantcast"/></a>'
+'</noscript>');
//<!-- End Quantcast tag -->
